...
import { User, Mail, Phone, MapPin, Truck, Save, Loader2 } from "lucide-react";
  ...
  return (
    <div className="p-4 lg:p-8 w-full max-w-[800px] mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm mt-1">Manage your delivery agent profile.</p>
      </div>
        ...
        <div className="flex items-center gap-4 mb-8 pb-8 border-b border-border/30">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground flex items-center gap-1.5 mt-1">
              <Truck size={12} className="text-emerald-500" /> Delivery Agent
            </p>
          </div>
        </div>
